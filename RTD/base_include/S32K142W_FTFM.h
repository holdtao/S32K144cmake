...
/*!
 * @file S32K142W_FTFM.h
 * @version 1.1
 * @date 2021-02-26
 * @brief Peripheral Access Layer for S32K142W_FTFM
 *
...
#if !defined(S32K142W_FTFM_H_)  /* Check if memory map has not been already included */
#define S32K142W_FTFM_H_
...
#endif  /* #if !defined(S32K142W_FTFM_H_) */
