 ...
 * @version 1.0
 * @date 2021-03-01
 * @brief Peripheral Access Layer for S32K118_RCM
 *
...
#if !defined(S32K118_RCM_H_)  /* Check if memory map has not been already included */
#define S32K118_RCM_H_
...
#endif  /* #if !defined(S32K118_RCM_H_) */
