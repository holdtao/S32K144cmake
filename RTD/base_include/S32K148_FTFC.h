 ...
 * @version 1.0
 * @date 2021-02-26
 * @brief Peripheral Access Layer for S32K148_FTFC
 *
...
#if !defined(S32K148_FTFC_H_)  /* Check if memory map has not been already included */
#define S32K148_FTFC_H_
...
#endif  /* #if !defined(S32K148_FTFC_H_) */
