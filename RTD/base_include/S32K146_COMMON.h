 ...
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K146_M4
 *
...
#if !defined(S32K146_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K146_COMMON_H_
#define MCU_S32K146

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32K146_M4 memory map: There is already included another memory map. Only one memory map can be included.
...
#define NUMBER_OF_INT_VECTORS 151                /**< Number of interrupts in the Vector table */
...
#endif  /* #if !defined(S32K146_COMMON_H_) */
