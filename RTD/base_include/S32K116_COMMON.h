...
#if !defined(S32K116_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K116_COMMON_H_
#define MCU_S32K116
...
typedef enum {
  ...
  CAN0_ORed_IRQn               = 10,               /**< CAN0 OR'ed Bus in Off State,Interrupt indicating Transmit Error Counter transition from less than 96 to greater and equal to 96,Interrupt indicating Receive Error Counter transition from less than 96 to greater and equal to 96,Interrupt indicating that errors were detected on the CAN bus, Interrupt indicating that errors were detected on the CAN bus for FD messages in the Fast Bit Rate region,Interrupt asserted when Pretended Networking operation is enabled, and a valid message matches the selected filter criteria during Low Power mode */
...
#endif  /* #if !defined(S32K116_COMMON_H_) */
