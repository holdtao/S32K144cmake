...
/*!
 * @file S32K142_FLEXCAN.h
 * @version 1.0
 * @date 2021-02-24
 * @brief Peripheral Access Layer for S32K142_FLEXCAN
 *
...
#if !defined(S32K142_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32K142_FLEXCAN_H_
...
#endif  /* #if !defined(S32K142_FLEXCAN_H_) */
