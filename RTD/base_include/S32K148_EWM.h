 ...
 * @version 1.0
 * @date 2021-02-26
 * @brief Peripheral Access Layer for S32K148_EWM
 *
...
#if !defined(S32K148_EWM_H_)  /* Check if memory map has not been already included */
#define S32K148_EWM_H_
...
#endif  /* #if !defined(S32K148_EWM_H_) */
