 ...
 * @version 1.0
 * @date 2021-03-01
 * @brief Peripheral Access Layer for S32K118_SMC
 *
...
#if !defined(S32K118_SMC_H_)  /* Check if memory map has not been already included */
#define S32K118_SMC_H_
...
#endif  /* #if !defined(S32K118_SMC_H_) */
