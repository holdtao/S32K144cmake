...
#if !defined(S32K144W_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K144W_COMMON_H_
#define MCU_S32K144W
...
typedef enum {
  ...
  FTFC_Read_Collision_IRQn     = 19,               /**< FTFM Read collision */
...
#endif  /* #if !defined(S32K144W_COMMON_H_) */
