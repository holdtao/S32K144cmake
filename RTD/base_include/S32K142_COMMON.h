...
#if !defined(S32K142_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K142_COMMON_H_
#define MCU_S32K142
...
typedef enum {
  ...
  FTFC_CC_IRQn                 = 18,               /**< FTFC Command complete */
...
#endif  /* #if !defined(S32K142_COMMON_H_) */
