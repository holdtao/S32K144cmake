 ...
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K146_ADC
 *
...
#if !defined(S32K146_ADC_H_)  /* Check if memory map has not been already included */
#define S32K146_ADC_H_
...
#define ADC_SC1ZZ_COUNT                           8u
#define ADC_RZZ_COUNT                             8u
...
#endif  /* #if !defined(S32K146_ADC_H_) */
