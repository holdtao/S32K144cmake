 ...
 * @version 1.1
 * @date 2021-02-26
 * @brief Peripheral Access Layer for S32K142W_RTC
 *
...
#if !defined(S32K142W_RTC_H_)  /* Check if memory map has not been already included */
#define S32K142W_RTC_H_
...
#endif  /* #if !defined(S32K142W_RTC_H_) */
