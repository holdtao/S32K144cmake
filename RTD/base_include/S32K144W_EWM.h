 ...
 * @version 1.3
 * @date 2021-02-25
 * @brief Peripheral Access Layer for S32K144W_EWM
 *
...
#if !defined(S32K144W_EWM_H_)  /* Check if memory map has not been already included */
#define S32K144W_EWM_H_
...
#endif  /* #if !defined(S32K144W_EWM_H_) */
