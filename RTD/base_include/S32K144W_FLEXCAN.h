...
/*!
 * @file S32K144W_FLEXCAN.h
 * @version 1.3
 * @date 2021-02-25
 * @brief Peripheral Access Layer for S32K144W_FLEXCAN
 *
...
#if !defined(S32K144W_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32K144W_FLEXCAN_H_
...
#define FLEXCAN_RAMn_COUNT                        256u
...
#endif  /* #if !defined(S32K144W_FLEXCAN_H_) */
