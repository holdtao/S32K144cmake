 ...
 * @version 1.0
 * @date 2021-02-26
 * @brief Peripheral Access Layer for S32K148_SAI
 *
...
#if !defined(S32K148_SAI_H_)  /* Check if memory map has not been already included */
#define S32K148_SAI_H_
...
#define IP_SAI0_BASE                             (0x40054000u)
/** Peripheral SAI0 base pointer */
#define IP_SAI0                                  ((SAI_Type *)IP_SAI0_BASE)
/** Peripheral SAI1 base address */
#define IP_SAI1_BASE                             (0x40055000u)
/** Peripheral SAI1 base pointer */
#define IP_SAI1                                  ((SAI_Type *)IP_SAI1_BASE)
/** Array initializer of SAI peripheral base addresses */
#define IP_SAI_BASE_ADDRS                        { IP_SAI0_BASE, IP_SAI1_BASE }
/** Array initializer of SAI peripheral base pointers */
#define IP_SAI_BASE_PTRS                         { IP_SAI0, IP_SAI1 }
...
#endif  /* #if !defined(S32K148_SAI_H_) */
