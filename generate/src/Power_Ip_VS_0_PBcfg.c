...
/* Check if source file and Power_Ip_VS_0_PBcfg.h file are of the same vendor */
#if (POWER_IP_PBCFG_VENDOR_ID_C != POWER_IP_PBCFG_VENDOR_ID)
    #error "Power_Ip_PBcfg.c and Power_Ip_VS_0_PBcfg.h have different vendor ids"
#endif
/* Check if source file and Power_Ip_VS_0_PBcfg.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Power_Ip_PBcfg.c and Power_Ip_VS_0_PBcfg.h are different"
#endif
/* Check if source file and Power_Ip_VS_0_PBcfg.h file are of the same Software version */
  ...
  #error "Software Version Numbers of Power_Ip_PBcfg.c and Power_Ip_VS_0_PBcfg.h are different"
#endif
