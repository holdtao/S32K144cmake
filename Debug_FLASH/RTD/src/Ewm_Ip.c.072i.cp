...
Determining dynamic type for call: Ewm_Ip_Refresh (1074139136B);
  Starting walk at: Ewm_Ip_Refresh (1074139136B);
  instance pointer: 1074139136B  Outer instance pointer: 1074139136B offset: 0 (bits) vtbl reference: 

IPA structures before propagation:

Jump functions:
  Jump functions of caller  Ewm_Ip_IrqHandler/13:
    indirect simple callsite, calling param -1, offset 0, for stmt _2 ();
  Jump functions of caller  Ewm_Ip_Service/12:
    callsite  Ewm_Ip_Service/12 -> Ewm_Ip_Refresh/3 : 
       param 0: CONST: 1074139136B
         value: 0x0, mask: 0xfffffff8
         VR  ~[0, 0]
  Jump functions of caller  Ewm_Ip_Init/11:
  Jump functions of caller  Ewm_Ip_Refresh/3:

 Propagating constants:

Not considering Ewm_Ip_IrqHandler for cloning; -fipa-cp-clone disabled.
Not considering Ewm_Ip_Service for cloning; -fipa-cp-clone disabled.
Not considering Ewm_Ip_Init for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: Ewm_Ip_IrqHandler/13:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: Ewm_Ip_Service/12:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
  ...
  Node: Ewm_Ip_Init/11:
    ...
    param [1]: BOTTOM
         ...
         VARYING
        AGGS BOTTOM
  Node: Ewm_Ip_Refresh/3:
    param [0]: 1074139136B [loc_time: 0, loc_size: 0, prop_time: 0, prop_size: 0]
         ctxs: VARIABLE
         Bits: value = 0x0, mask = 0xfffffff8
         struct EWM_Type * const [1074139136B, 1074139136B]
        AGGS VARIABLE

IPA decision stage:

 - Creating a specialized node of Ewm_Ip_Refresh/3 for all known contexts.
    replacing param #0 base with const 1074139136B
Propagated bits info for function Ewm_Ip_Refresh.constprop/14:
 param 0: value = 0x0, mask = 0xfffffff8
Propagated bits info for function Ewm_Ip_Refresh/3:
 param 0: value = 0x0, mask = 0xfffffff8

IPA constant propagation end

Reclaiming functions: Ewm_Ip_Refresh/3
...
Ewm_Ip_Refresh.constprop.0/14 (Ewm_Ip_Refresh.constprop) @05d228c0
  ...
  Called by: Ewm_Ip_Service/12 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
...
Ewm_Ip_Service/12 (Ewm_Ip_Service) @05d26a80
  ...
  Called by: 
  Calls: Ewm_Ip_Refresh.constprop/14 (1073741824 (estimated locally),1.00 per call) 
...
Modification phase of node Ewm_Ip_Init/11
...
Modification phase of node Ewm_Ip_Service/12
...
Modification phase of node Ewm_Ip_IrqHandler/13
