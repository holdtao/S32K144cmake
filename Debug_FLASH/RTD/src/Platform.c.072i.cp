...
Jump functions:
  Jump functions of caller  IntCtrl_Ip_InstallHandler/17:
...
Platform_Ipw_SetIrq/1 (Platform_Ipw_SetIrq) @06ee82a0
  ...
  Calls: IntCtrl_Ip_DisableIrq/14 (536870913 (estimated locally),0.50 per call) IntCtrl_Ip_EnableIrq/13 (536870913 (estimated locally),0.50 per call) 
