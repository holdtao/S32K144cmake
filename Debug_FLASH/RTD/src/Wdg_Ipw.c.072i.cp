...
Jump functions:
  Jump functions of caller  Ewm_Ip_Service/13:
  Jump functions of caller  Wdog_Ip_Service/12:
  Jump functions of caller  Wdog_Ip_StopTimer/11:
  Jump functions of caller  Wdog_Ip_StartTimer/10:
  Jump functions of caller  Wdog_Ip_Config/9:
  Jump functions of caller  Ewm_Ip_Init/8:
  Jump functions of caller  Det_ReportRuntimeError/7:
  Jump functions of caller  Wdog_Ip_Init/6:
  Jump functions of caller  Wdg_Ipw_Service/5:
...
Not considering Wdg_Ipw_Service for cloning; -fipa-cp-clone disabled.
Not considering Wdg_Ipw_StopTimer for cloning; -fipa-cp-clone disabled.
Not considering Wdg_Ipw_StartTimer for cloning; -fipa-cp-clone disabled.
Not considering Wdg_Ipw_SetMode for cloning; -fipa-cp-clone disabled.
Not considering Wdg_Ipw_Init for cloning; -fipa-cp-clone disabled.

overall_size: 103, max_new_size: 11001

IPA lattices after all propagation:

Lattices:
  Node: Wdg_Ipw_Service/5:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
aeWdg_Ipw_Ip/0 (aeWdg_Ipw_Ip) @05d6e120
  ...
  References: 
  Referring: Wdg_Ipw_StartTimer/3 (read)Wdg_Ipw_SetMode/2 (write)Wdg_Ipw_StopTimer/4 (read)Wdg_Ipw_Init/1 (write)Wdg_Ipw_Service/5 (read)
  Availability: available
  Varpool flags: initialized

;; Function Wdg_Ipw_Init (Wdg_Ipw_Init, funcdef_no=0, decl_uid=5612, cgraph_uid=1, symbol_order=1)
...
;; Function Wdg_Ipw_SetMode (Wdg_Ipw_SetMode, funcdef_no=1, decl_uid=5615, cgraph_uid=2, symbol_order=2)
...
;; Function Wdg_Ipw_StartTimer (Wdg_Ipw_StartTimer, funcdef_no=2, decl_uid=5617, cgraph_uid=3, symbol_order=3)
...
;; Function Wdg_Ipw_StopTimer (Wdg_Ipw_StopTimer, funcdef_no=3, decl_uid=5619, cgraph_uid=4, symbol_order=4)
...
;; Function Wdg_Ipw_Service (Wdg_Ipw_Service, funcdef_no=4, decl_uid=5621, cgraph_uid=5, symbol_order=5)

Modification phase of node Wdg_Ipw_Service/5
