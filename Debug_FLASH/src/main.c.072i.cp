...
Jump functions:
  Jump functions of caller  Wdg_43_Instance1_SetTriggerCondition/23:
  Jump functions of caller  Wdg_43_Instance1_Init/21:
  Jump functions of caller  Wdg_43_Instance0_SetMode/20:
  Jump functions of caller  Wdg_43_Instance0_SetTriggerCondition/19:
  Jump functions of caller  Wdg_43_Instance0_Init/17:
  Jump functions of caller  Gpt_EnableNotification/16:
  Jump functions of caller  Gpt_Init/14:
  Jump functions of caller  Wdg_Ipw_Isr/13:
  Jump functions of caller  FTM_0_CH_0_CH_1_ISR/12:
  Jump functions of caller  LPIT_0_CH_0_ISR/11:
  Jump functions of caller  Platform_InstallIrqHandler/10:
  Jump functions of caller  Platform_SetIrq/9:
  Jump functions of caller  Platform_Init/8:
  Jump functions of caller  Mcu_SetMode/7:
  Jump functions of caller  Mcu_InitClock/6:
  Jump functions of caller  Mcu_Init/5:
  Jump functions of caller  main/4:
    callsite  main/4 -> delay/2 : 
       param 0: CONST: 5000000
         value: 0x4c4b40, mask: 0x0
         Unknown VR
    callsite  main/4 -> delay/2 : 
       param 0: CONST: 50000
         value: 0xc350, mask: 0x0
         Unknown VR
  Jump functions of caller  Wdg_CallBackNotification1/3:
  Jump functions of caller  delay/2:

 Propagating constants:

Not considering main for cloning; -fipa-cp-clone disabled.
Not considering Wdg_CallBackNotification1 for cloning; -fipa-cp-clone disabled.
Not considering delay for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: main/4:
  Node: Wdg_CallBackNotification1/3:
  Node: delay/2:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
;; Function delay (delay, funcdef_no=1, decl_uid=7330, cgraph_uid=2, symbol_order=2)

Modification phase of node delay/2
...
;; Function Wdg_CallBackNotification1 (Wdg_CallBackNotification1, funcdef_no=2, decl_uid=7343, cgraph_uid=3, symbol_order=3)

Modification phase of node Wdg_CallBackNotification1/3
...
;; Function main (main, funcdef_no=3, decl_uid=7346, cgraph_uid=4, symbol_order=4) (executed once)
